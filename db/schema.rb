...
ActiveRecord::Schema.define(:version => 20131216020621) do
  ...
  create_table "mobile_campaign_versions", :force => true do |t|
  ...
  add_index "mobile_campaign_versions", ["item_type", "item_id"], :name => "index_mobile_campaign_versions_on_item_type_and_item_id"
